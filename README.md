...
## Etat du projet : V0.5 en cours.
### Fonctions pour la V0.5 de Myr-Bot [Discord]
...
### MISE A JOUR MATERIEL EN COURS 
Passage de la structure hardware d'un raspberry seul à un serveur plus cohérent et solide.
